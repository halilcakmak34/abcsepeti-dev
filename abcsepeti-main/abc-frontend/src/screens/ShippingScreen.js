  ...
  return (
    <>
      ...
      <Row className='mx-5 justify-content-md-center'>
        <h1 className='mx-5 justify-content-md-center'>{t('welcome:shippingScreen.address')}</h1>
      </Row>
      <hr></hr>
      <>
        <Row>
          <Col xs={12} md={6}>
            {addressListLoading ? (
              ...
              <>
                ...
                <h2>{t('welcome:shippingScreen.select.billing.address')}</h2>
                {addresses.map((a) => (
                  <div key={a.addressId}>
                ...
                {!shippingCheckbox && (
                  <>
                    <h2>{t('welcome:shippingScreen.select.shipping.address')}</h2>
                    {addresses.map((a) => (
                      <div key={a.addressId}>
                        <ListGroup.Item variant='flush'>
                          <InputGroup>
          ...
          <Col xs={12} md={6}>
            ...
            <h2>
              <p>{t('welcome:shippingScreen.addNewAddress')}</p>
            </h2>
            <Form onSubmit={saveAddressHandler}>
              <Row className='mx-5 justify-content-md-center'>
                <Col>
                  <Form.Group controlId='addressLine1'>
                    <Form.Label>{t('welcome:shippingScreen.addressLine1')}</Form.Label>
                    <Form.Control
                      required
                      placeholder={t('welcome:shippingScreen.enter.addressLine1')}
                      value={addressLine1}
                  ...
                  <Form.Group controlId='addressLine2'>
                    <Form.Label>{t('welcome:shippingScreen.addressLine2')}</Form.Label>
                    <Form.Control
                      type='text'
                      placeholder={t('welcome:shippingScreen.enter.addressLine1')}
                      value={addressLine2}
                  ...
                  <Form.Group controlId='city'>
                    <Form.Label>{t('welcome:shippingScreen.city')}</Form.Label>
                    <Form.Control
                      type='text'
                      placeholder={t('welcome:shippingScreen.enter.city')}
                      value={city}
                      required
                  ...
                  <Form.Group controlId='state'>
                    <Form.Label>{t('welcome:shippingScreen.state')}</Form.Label>
                    <Form.Control
                      type='text'
                      placeholder={t('welcome:shippingScreen.enter.state')}
                      value={state}
                      required
                  ...
                  <Form.Group controlId='country'>
                    <Form.Label>{t('welcome:shippingScreen.countryCode')}</Form.Label>
                    <Form.Control as='select' value={country} required onChange={(e) => setCountry(e.target.value)}>
                      <option value='0'>{t('welcome:shippingScreen.select.country')}</option>
                  ...
                  <Form.Group controlId='postalCode'>
                    <Form.Label>{t('welcome:shippingScreen.postalCode')}</Form.Label>
                    <Form.Control
                      type='text'
                      placeholder={t('welcome:shippingScreen.enter.postalCode')}
                      value={postalCode}
                      required
                  ...
                  <Form.Group controlId='phone'>
                    <Form.Label>{t('welcome:shippingScreen.phone')}</Form.Label>
                    <Form.Control
                      type='number'
                      placeholder={t('welcome:shippingScreen.enter.phone')}
                      value={phone}
              ...
              <Row className='mx-5 justify-content-md-center'>
                <Button type='submit' variant='primary' disabled={addressSaveLoading}>
                  {addressSaveLoading ? (
                    ...
                    <>{t('welcome:shippingScreen.addNewAddress')}</>
                  )}
                </Button>
              </Row>
            </Form>
        ...
        <Row className='mx-5 justify-content-md-center'>
          <Button type='submit' variant='primary' onClick={proceedToPayment} className='mt-3' disabled={!shippingAddressId}>
            {t('welcome:shippingScreen.proceedToPayment')}
          </Button>
        </Row>
      </>
    </>
