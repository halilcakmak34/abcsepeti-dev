...
const UserListScreen = ({ history }) => {
  ...
  return (
    <>
      <h1>{t('welcome:usersList.users')}</h1>
      ...
      {loading ? (
        ...
        <Table striped bordered hover responsive className='table-sm'>
          <thead>
            <tr>
              <th>{t('welcome:usersList.id')}</th>
              <th>{t('welcome:usersList.userName')}</th>
              <th>{t('welcome:usersList.first.name')}</th>
              <th>{t('welcome:usersList.last.name')}</th>
              <th>{t('welcome:usersList.email')}</th>
              <th>{t('welcome:usersList.roles')}</th>
              <th></th>
            </tr>
          </thead>
          <tbody>
