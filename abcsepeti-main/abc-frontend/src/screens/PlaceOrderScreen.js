        ...
        <Row>
          <Col md={8}>
            <ListGroup variant='flush'>
              <ListGroup.Item>
                <h2>{t('welcome:placeOrderScreen.shipping')}</h2>
                <p>
                  <strong>{t('welcome:placeOrderScreen.address')}:</strong>
              ...
              <ListGroup.Item>
                <h2>{t('welcome:placeOrderScreen.payment.method')}</h2>
                <strong>{t('welcome:placeOrderScreen.method')}: </strong>
              ...
              <ListGroup.Item>
                ...
                {previewOrderResponse.orderItems.length === 0 ? (
                  <Message>{t('welcome:placeOrderScreen.yourCardIsEmpty')}</Message>
                ) : (
                  <ListGroup variant='flush'>
          ...
          <Col md={4}>
            <Card>
              <ListGroup variant='flush'>
                <ListGroup.Item>
                  <h2> {t('welcome:placeOrderScreen.order.summary')}</h2>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>{t('welcome:placeOrderScreen.items')}</Col>
                    <Col>${previewOrderResponse.itemsTotalPrice}</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>{t('welcome:placeOrderScreen.shipping')}</Col>
                    <Col>${previewOrderResponse.shippingPrice}</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>{t('welcome:placeOrderScreen.tax')}</Col>
                    <Col>${previewOrderResponse.taxPrice}</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>{t('welcome:placeOrderScreen.total')}</Col>
                ...
                <ListGroup.Item>
                  <Button type='button' className='btn-block' disabled={previewOrderResponse.orderItems === 0} onClick={placeOrderHandler}>
                    {t('welcome:placeOrderScreen.place.order')}
                  </Button>
                </ListGroup.Item>
              </ListGroup>
            </Card>
