  ...
  return (
    <>
      <Link to='/admin/productlist' className='btn btn-dark my-3'>
        {t('welcome:productEdit.go.back')}
      </Link>
      <h1> {t('welcome:productEdit.edit.product')}</h1>
      <hr></hr>
          ...
          <Row>
            ...
            <Col>
              <Form.Group controlId='name'>
                <Form.Label>{t('welcome:productEdit.name')}</Form.Label>
                <Form.Control
                  type='name'
                  placeholder={t('welcome:productEdit.enter.name')}
                  value={productName}
              ...
              <Form.Group controlId='price'>
                <Form.Label>{t('welcome:productEdit.price')}</Form.Label>
                <Form.Control
                  type='number'
                  placeholder={t('welcome:productEdit.enter.price')}
                  value={price}
              ...
              <Form.Group controlId='countInStock'>
                <Form.Label>{t('welcome:productEdit.count.in.stock')}</Form.Label>
                <Form.Control
                  type='number'
                  placeholder={t('welcome:productEdit.enter.countInStock')}
              ...
              <Form.Group controlId='description'>
                <Form.Label>{t('welcome:productEdit.description')}</Form.Label>
                <Form.Control
                  type='text'
                  placeholder={t('welcome:productEdit.enter.description')}
                  value={description}
