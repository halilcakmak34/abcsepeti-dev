...
export const getCategoryDetailApi = async (categoryId) => {
  const responseData = axios.get(`${BACKEND_API_GATEWAY_URL}/api/catalog/category/${categoryId}`).then((response) => {
    return response.data;
  });
  return responseData;
};
...
export const createCategoryApi = async (categoryReqBody) => {
  const axiosConfig = getAxiosConfig();
  const responseData = await axios.post(`${BACKEND_API_GATEWAY_URL}/api/catalog/category`, categoryReqBody, axiosConfig).then((response) => {
    return response.data;
  });
  return responseData;
};
...
export const updateCategoryApi = async (categoryReqBody) => {
  const axiosConfig = getAxiosConfig();
  const responseData = await axios.put(`${BACKEND_API_GATEWAY_URL}/api/catalog/category`, categoryReqBody, axiosConfig).then((response) => {
    return response.data;
  });
  return responseData;
};
...
export const deleteCategoryApi = async (categoryId) => {
  const axiosConfig = getAxiosConfig();
  const responseData = await axios.delete(`${BACKEND_API_GATEWAY_URL}/api/catalog/category/${categoryId}`, axiosConfig).then((response) => {
    return response.data;
  });
  return responseData;
};
...
export const getCategories = async () => {
  const responseData = axios
    .get(`${BACKEND_API_GATEWAY_URL}/api/catalog/allCategory`)
    .then((response) => {
      return response.data;
    });
  return responseData;
...
export const getAllCategories = async () => {
  const responseData = axios
    .get(`${BACKEND_API_GATEWAY_URL}/api/catalog/category/getAll`)
    .then((response) => {
      return response.data;
    });
  return responseData;
...
export const getAllCategoriesApi = async (pageNumber) => {
  const responseData = axios.get(`${BACKEND_API_GATEWAY_URL}/api/catalog/categories?page=${pageNumber}&size=8&sort=categoryName`).then((response) => {
    return response.data;
  });
  return responseData;
};

export const getAllProductsDetailApi = async (pageNumber,searchKey) => {
  const responseData = axios.get(`${BACKEND_API_GATEWAY_URL}/api/catalog/products?page=${pageNumber}&size=8&searchKey=${searchKey}`).then((response) => {
    return response.data;
  });
  return responseData;
};
